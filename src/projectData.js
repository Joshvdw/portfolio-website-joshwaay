const projects = [
  {
    ...
    image: './images/projects/lotje-mcdonald.png',
    ...
    tools: ['Wordpress', 'WooCommerce', 'Security', 'SEO'],
  ...
  {
    title: 'Torotoro',
    image: './images/projects/torotoro.jpg',
    ...
    tools: ['React', 'Redux', 'Node', 'Express', 'SASS', 'Figma'],
  ...
  },
  {
    ...
    image: './images/projects/prelude.png',
    description: "I was part of the development team that created the graduation website for Yoobee Colleges in 2021. I was nominated to be dev lead and was mainly in charge of the JavaScript, making sure the data dynamically renders to the DOM.",
  ...
  },
  {
    ...
    image: './images/projects/jack-robert.png',
    description: "Website designed for an imaginary photographer called Jack Robert, build from the ground up using a custom Wordpress theme - as well as custom post types, metaboxes, plugins and taxonomies.",
    tools: ['Wordpress', 'PHP', 'JavaScript', 'Figma'],
  ...
  {
    title: 'Ticket Trade',
    image: './images/projects/ticket-trade.png',
    description: "A user-generated ecommerce app for buying or selling event tickets online. This app allows users to create an account, log in and post or edit event tickets, as well as view other user's tickets, buy them or leave comments.",
    tools: ['Node', 'Express', 'MongoDB', 'Mongoose', 'Express'],
  ...
  },
  {
    ...
    image: './images/projects/toughlove.png',
  ...
  {
    title: 'Earth Tongue',
    image: './images/projects/earth-tongue.jpg',
